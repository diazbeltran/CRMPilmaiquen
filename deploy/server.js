...
function serveStaticFile(req, res) {
  ...
  const relativePath = urlPath.replace(/^\/_next\//, '/')

  const candidates = [
    path.join(dir, '.next', relativePath),
    path.join(dir, 'public', urlPath),
  ]
